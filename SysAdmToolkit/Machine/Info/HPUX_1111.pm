...
sub _init() {
	...
	my $procFreqCmd = "echo 'itick_per_tick/D' | $debugger -k $kernelLocation $memDev | tail -1";
	my $memoryCmd = "echo 'phys_mem_pages/D' | $debugger -k $kernelLocation $memDev | tail -1";
