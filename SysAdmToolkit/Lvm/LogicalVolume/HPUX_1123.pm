package SysAdmToolkit::Lvm::LogicalVolume::HPUX_1123;

=head1 NAME

SysAdmToolkit::Lvm::LogicalVolume::HPUX_1123 - HP-UX 11.23 moodule for getting LVM info about logical volumes

=head1 SYNOPSIS

	my $lvol= SysAdmToolkit::Lvm::LogicalVolume::HPUX_1123->new('lv' => '/dev/vgroot/lvol1');

	or

	my $lvol= SysAdmToolkit::Lvm::LogicalVolume::HPUX_1123->new('lv' => 'lvol1', 'vg' => 'vgroot');							
