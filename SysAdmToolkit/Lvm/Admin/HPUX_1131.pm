package SysAdmToolkit::Lvm::Admin::HPUX_1131;

=head1 NAME

SysAdmToolkit::Lvm::Admin::HPUX_1131 - HP-UX 11.31 specific module for getting high level info about LVM on machine

=head1 SYNOPSIS

	my $lvmAdmin = SysAdmToolkit::Lvm::Admin::HPUX_1131->new();
