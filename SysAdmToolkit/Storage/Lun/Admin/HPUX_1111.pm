package SysAdmToolkit::Storage::Lun::Admin::HPUX_1111;

=head1 NAME

SysAdmToolkit::Storage::Lun::Admin::HPUX_1111 - interface module for getting info about Luns

=head1 SYNOPSIS

	my $lunAdmin = SysAdmToolkit::Storage::Lun::Admin::HPUX_1111->new();
