package SysAdmToolkit::Storage::Lun::HPUX_1111;

=head1 NAME

SysAdmToolkit::Storage::Lun::HPUX_1111 - this is HP-UX 11.11 specific module for getting info about lun

=head1 SYNOPSIS

	my $myLun = SysAdmToolkit::Storage::Lun::HPUX_1111->new();
