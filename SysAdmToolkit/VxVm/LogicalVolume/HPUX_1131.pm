package SysAdmToolkit::VxVm::LogicalVolume::HPUX_1131;

=head1 NAME

SysAdmToolkit::VxVm::LogicalVolume::HPUX_1131 - HP-UX 11.31 moodule for getting VxVm info about logical volumes

=head1 SYNOPSIS

	my $lvol= SysAdmToolkit::VxVm::LogicalVolume::HPUX_1131->new('lv' => 'lvol1', 'vg' => 'newdg');							
